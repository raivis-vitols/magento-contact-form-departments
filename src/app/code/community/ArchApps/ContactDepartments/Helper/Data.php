...
class ArchApps_ContactDepartments_Helper_Data extends Mage_Core_Helper_Abstract
{
    const XML_PATH_ENABLED     = 'contacts/departments/enabled';
    const XML_PATH_DEPARTMENTS = 'contacts/departments/departments';
    const XML_PATH_FIELD_LABEL = 'contacts/departments/field_label';
    ...
    /**
     * Returns specified label to be displayed for department field
     *
     * @return mixed
     */
    public function getFieldLabel()
    {
        return Mage::getStoreConfig(self::XML_PATH_FIELD_LABEL);
    }
